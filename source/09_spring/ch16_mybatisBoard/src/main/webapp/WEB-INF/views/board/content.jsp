...
<body>
	...
	<table>
		...
		<tr>
			<td colspan="2">
				<button onclick="location.href='${conPath}/modify.do?bid=${param.bid}&pageNum=${param.pageNum}'">수정</button>
				<button onclick="location.href='${conPath}/delete.do?bid=${param.bid }&pageNum=${param.pageNum }'">삭제</button>
				<button onclick="location.href='${conPath}/reply.do?bid=${param.bid }&pageNum=${param.pageNum }'">답변</button>
