...
public class HomeController {
	...
	public String textMail(String name, String email, Model model) {
		...
		message.setTo(email);
		message.setSubject("[TEXT 감사메일]" + name + "님 회원가입 감사합니다.");
	...
	public String htmlMail(final String name, final String email, Model model) {
		MimeMessagePreparator message = new MimeMessagePreparator() {
			String content = 
						    ...
						    "		<img src=\"http://localhost:9000/ch17/img/coupon.jpg\">\n" +
						    "	</div>\n" +
			...
			public void prepare(MimeMessage mimeMessage) throws Exception {
				...
				mimeMessage.setFrom(new InternetAddress("yubin.j0908@gmail.com"));
				mimeMessage.setSubject("[html 감사메일]" + name + "님 회원가입 갑사합니다.");
