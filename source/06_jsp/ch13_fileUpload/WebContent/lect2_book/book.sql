-- DROP & CREATE FOR TABLE & SEQUENCE
DROP TABLE BOOK;
...
CREATE TABLE BOOK (
  ...
  BRDATE DATE DEFA+ULT SYSDATE NOT NULL
);
...
INSERT INTO BOOK (BID, BTITLE, BPRICE, BIMG1, BIMG2, BCONTENT, BDISCOUNT)
       VALUES (BOOK_SEQ.NEXTVAL, 'JSP 웹 프로그래밍', 30000, 'noImg.png', 'NOTHING.JPG', '???', 15);
INSERT INTO BOOK (BID, BTITLE, BPRICE, BIMG1, BIMG2, BCONTENT, BDISCOUNT)
       VALUES (BOOK_SEQ.NEXTVAL, 'SPRING', 28000, 'noImg.png', 'NOTHING.JPG', '????????', 25);
