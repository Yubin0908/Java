...
<body>
	<form action="<%=conPath%>/lect2_book/bookRegisterPro.jsp" method="post" enctype="multiport/form-data">
		<table>
			<caption>책등록</caption>
			<tr>
				<th>책제목</th>
				<td><input type="text" name="btitle" maxlength="33" required autofocus></td>
			</tr>
			<tr>
				<th>가격</th>
				<td><input type="number" name="bprice" min="0" required></td>
			</tr>
			<tr>
				<th>대표이미지</th>
			...
			<tr>
				<th>할인율</th>
				<td><input type="number" name="bdiscount" min="0" max="100" value="0" required></td>
			</tr>
			<tr>
				<td colspan="2">
