...
<head>
	...
	<link href="css/joinagree.css" rel="stylesheet">
</head>
<body>
<jsp:include page="header.jsp" />
	<div id="join_agree_wrap">
    <div class="join_sub_title">
      <p class="desc">회원가입</p>
      <p class="title bold">CREATE ACCOUNT</p>
    </div>
    <div class="join_step"><p>이용약관동의</p></div>
    <div class="col-area">
      <form action="agreeAction.jsp">
        <div class="col-area-title">이용약관</div>
        <div class="col-area-text">
          <textarea class="nosize" cols="60" rows="30" readonly>
제1조(목적)
이 약관은 멍이랑냥이랑 회사(전자거래 사업자)가 운영하는 멍이랑냥이랑 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
※ 「PC통신등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는한 이 약관을 준용합니다」
제2조(정의)
① "몰"이란 멍이랑냥이랑 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
1. 이 약관은 0000년 00월 00일부터 적용됩니다.
      ...
      <div class="col-area">
        <div class="col-area-title">개인정보 취급방침</div>
        <div class="col-area-text">
          <textarea class="nosize" cols="60" rows="30" readonly>
  개인정보의 수집목적 및 이용목적

  ① 멍이랑냥이랑몰은 회원님께 최대한으로 최적화되고 맞춤화된 서비스를 제공하기 위하여 다음과 같은 목적으로 개인정보를 수집하고 있습니다.
  ...
  개인정보의 수집범위
  멍이랑냥이랑몰은 별도의 회원가입 절차 없이 대부분의 컨텐츠에 자유롭게 접근할 수 있습니다. 멍이랑냥이랑몰의 회원제 서비스를 이용하시고자 할 경우 다음의 정보를 입력해주셔야 하며 선택항목을 입력하시지 않았다 하여 서비스 이용에 제한은 없습니다.
  ...
  비회원의 고객 개인정보보호
  멍이랑냥이랑몰은 회원 뿐만 아니라 비회원 또한 물품 및 서비스 상품의 구매를 하실 수 있습니다. 멍이랑냥이랑몰은 비회원 주문의 경우 배송 및 대금 결제, 상품 배송에 반드시 필요한 개인정보 만을 고객에게 요청하고 있습니다.
  멍이랑냥이랑몰에서 비회원으로 구매를 하신 경우 비회원 고객께서 입력하신 지불인 정보 및 수령인 정보는 대금 결제 및 상품 배송에 관련한 용도 외에는 다른 어떠한 용도로도 사용되지 않습니다.
  멍이랑냥이랑몰 비회원의 경우도 멍이랑냥이랑몰 회원과 동일하게 개인정보를 보호합니다.
  쿠키에 의한 개인정보 수집
  ① 쿠키(cookie)란?
  멍이랑냥이랑몰은 귀하에 대한 정보를 저장하고 수시로 찾아내는 쿠키(cookie)를 사용합니다. 쿠키는 웹사이트가 귀하의 컴퓨터 브라우저(넷스케이프, 인터넷 익스플로러 등)로 전송하는 소량의 정보입니다. 귀하께서 웹사이트에 접속을 하면 멍이랑냥이랑몰의 컴퓨터는 귀하의 브라우저에 있는 쿠키의 내용을 읽고, 귀하의 추가정보를 귀하의 컴퓨터에서 찾아 접속에 따른 성명 등의 추가 입력 없이 서비스를 제공할 수 있습니다. 쿠키는 귀하의 컴퓨터는 식별하지만 귀하를 개인적으로 식별하지는 않습니다. 또한 귀하는 쿠키에 대한 선택권이 있습니다. 웹브라우저 상단의 도구 > 인터넷옵션 탭(option tab)에서 모든 쿠키를 다 받아들이거나, 쿠키가 설치될 때 통지를 보내도록 하거나, 아니면 모든 쿠키를 거부할 수 있는 선택권을 가질 수 있습니다.
  ② 멍이랑냥이랑몰의 쿠키(cookie) 운용
  멍이랑냥이랑몰은 이용자의 편의를 위하여 쿠키를 운영합니다. 멍이랑냥이랑몰이 쿠키를 통해 수집하는 정보는 멍이랑냥이랑몰 회원 ID에 한하며, 그 외의 다른 정보는 수집하지 않습니다. 멍이랑냥이랑몰이 쿠키(cookie)를 통해 수집한 회원 ID는 다음의 목적을 위해 사용됩니다.
